...
We have fixed a number of bugs and made several enhancements in this release. Refer to the [changelog](https://github.com/mariadb-operator/mariadb-operator/releases/tag/25.08.0) for further detail. 
