...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `enabled` _boolean_ | Enabled indicates whether TLS is enabled, determining if certificates should be issued and mounted to the MaxScale instance. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `enabled` _boolean_ | Enabled indicates whether TLS is enabled, determining if certificates should be issued and mounted to the MariaDB instance. |  |  |
| `required` _boolean_ | Required specifies whether TLS must be enforced for all connections.<br />User TLS requirements take precedence over this.<br />It is enabled by default. |  |  |
...
| `galeraSSTEnabled` _boolean_ | GaleraSSTEnabled determines whether Galera SST connections should use SSL. It is enabled with Galera by default. |  |  |
