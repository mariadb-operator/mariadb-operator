...
require (
	...
	github.com/mariadb-operator/mariadb-operator/pkg/client v0.0.0-00010101000000-000000000000
...
replace github.com/mariadb-operator/mariadb-operator/pkg/client => ./pkg/client
