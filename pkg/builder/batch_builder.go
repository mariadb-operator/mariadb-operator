...
import (
	...
	cmd "github.com/mmontes11/mariadb-operator/pkg/command"
	backupcmd "github.com/mmontes11/mariadb-operator/pkg/command/backup"
	sqlcmd "github.com/mmontes11/mariadb-operator/pkg/command/sql"
