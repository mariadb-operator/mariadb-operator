...
func (r *RBACReconciler) Reconcile(ctx context.Context, mariadb *mariadbv1alpha1.MariaDB) error {
	...
	if err := r.reconcileRoleBinding(ctx, mariadb, role, sa); err != nil {
...
func (r *RBACReconciler) reconcileRoleBinding(ctx context.Context, mariadb *mariadbv1alpha1.MariaDB, role *rbacv1.Role,
	...
	roleBinding, err := r.builder.BuildRoleBinding(key, mariadb, role, sa)
	if err != nil {
