...
// NewCrdStrategy is used to setup some defaults for the CrdStrategy
// By default this waits for the user, but not the grant to be created, to keep things backwards compatible
