...
RELATED_IMAGE_MAXSCALE_VERSION ?= 23.08.6
RELATED_IMAGE_MAXSCALE ?= $(RELATED_IMAGE_MAXSCALE_NAME):$(RELATED_IMAGE_MAXSCALE_VERSION)

RELATED_IMAGE_MAXSCALE_ENT_NAME ?= mariadb/maxscale
RELATED_IMAGE_MAXSCALE_ENT_VERSION ?= 23.08.6-ubi
...
RELATED_IMAGE_EXPORTER_ENT_NAME ?= mariadb/mariadb-prometheus-exporter-ubi
...
RELATED_IMAGE_EXPORTER_MAXSCALE_ENT_NAME ?= mariadb/maxscale-prometheus-exporter-ubi
