...
.PHONY: client-validate
client-validate: ## Run sample client application in validate mode.
	$(GO) run hack/client/*.go $(CLIENT_FLAGS) --mode=validate --validate-threshold=1s
