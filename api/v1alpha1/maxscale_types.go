...
// +operator-sdk:csv:customresourcedefinitions:resources={{MaxScale,v1alpha1},{User,v1alpha1},{Grant,v1alpha1},{Service,v1},{Secret,v1},{Event,v1},{Deployment,v1},{PersistentVolumeClaim,v1},{PodDisruptionBudget,v1}}
