				...
				&Galera{
					...
					GaleraSpec: GaleraSpec{
						...
						Recovery: &GaleraRecovery{
							...
							ClusterBootstrapTimeout: ptr.To(metav1.Duration{Duration: 3 * time.Minute}),
							PodRecoveryTimeout:      ptr.To(metav1.Duration{Duration: 30 * time.Second}),
							PodSyncTimeout:          ptr.To(metav1.Duration{Duration: 30 * time.Second}),
						},
					},
				},
			),
